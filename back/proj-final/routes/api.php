...
Route::get('tasks/branca/{id}', [TaskController::class, 'index'])->middleware('auth:sanctum');
Route::get('tasks/carrec/{id}', [TaskController::class, 'index'])->middleware('auth:sanctum');
